...
IMAGE_INSTALL:append:zynqmp = " ${VITISAI_DEPENDENCIES} xrt hellopm cppzmq-dev jansson kernel-devsrc mosquitto"
# Temporarily disabled: " kernel-module-dp kernel-module-hdmi"
...
# Temporarily disabled: "  kernel-module-hdmi"
